...
function displayError(field, message) : boolean {
 ...
 function clearError(field) : boolean{
  ...
  function employeeValidation(value, fieldName) : void {
    ...
    switch (fieldName) {
      ...
      case 'firstName':
          ...
          getInputElement('inputPreferedName').value =firstName;
      ...
      case 'lastName':
          lastName = value;
          getInputElement('inputPreferedName').value = fname+ " "+lastName;
      ...
      case 'mobile':
          mobile = value.trim();
          let input1 = getInputElement('inputMobile');
  ...
  function validateField(field, value) : void {
